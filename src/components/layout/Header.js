  ...
  const navLinks = useMemo(() => {
    return [
      ...
      },
      {
        ...
        id: "competitions",
        isActive: currentPath === "/#competitions",
      },
      {
        href: "/#how-it-works",
      ...
      <div className="max-w-[1440px] w-full px-6 sm:px-8 md:px-16 lg:px-20">
        <div className="flex justify-between items-center py-8">
          ...
          <div className="lg:hidden">
            <div className="flex items-center">
              <Button
                ...
                classes={
                  "bg-dark hover:bg-orange text-white whitespace-nowrap h-11 mx-auto"
                }
              />

              <button
                onClick={toggleMenu}
                className="ml-2 w-11 h-11 p-1 rounded-lg inline-flex items-center justify-center transition-colors duration-300 hover:bg-gray-300 border border-[#59595986]"
              >
          ...
          <nav
            ...
            } lg:flex lg:relative lg:bg-transparent lg:z-auto`}
          >
                ...
                <div className="absolute top-0 right-0 p-4 flex justify-between w-full">
                  <Link href="/" passHref onClick={toggleMenu}>
                    <img
                      src={`${"/logo.png"}`}
                      alt="Logo"
                      className="max-w-16 lg:max-w-24 cursor-pointer"
                    />
                  </Link>
                  <Button
                    text={""}
                    ...
                    onClick={toggleMenu}
                    classes={
                      "absolute z-10 top-3 right-3 bg-gray-300 hover:bg-gray-400 rounded-lg !px-1 !pr-3 flex items-center justify-center"
                    }
                  />
                </div>
              )}
              ...
              {navLinks.map((link) => {
                return (
                  <Link
                    ...
                    href={link.href}
                    passHref
                    className={`block lg:inline-flex items-center px-3 py-2 rounded-lg transition-colors duration-300 text-sm text-center ${
                      link.isActive
                  ...
                  >
                    <span
                      ...
                      } mr-2 h-2 w-2 rounded-full bg-orange`}
                    />{" "}
                    {link.label}
                  </Link>
                );
              ...
              {isOpen && (
                <div className="mt-8">
                  <Button
                    ...
                    classes={
                      "bg-dark hover:bg-orange text-white whitespace-nowrap h-11 mt-4 mx-auto"
                    }
                  />
                </div>
              )}
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button
              ...
              onClick={openJoinModal}
              classes={
                "ml-4 bg-dark hover:bg-orange text-white whitespace-nowrap h-14"
              }
            />
          </div>
        </div>
