          ...
          <div className="flex flex-col items-center m-auto text-center pt-8">
            <h1 className="relative text-4xl md:text-5xl mb-6 leading-tight lg:max-w-4xl">
              ...
              <img
                ...
                className="absolute -top-16 sm:-top-10 -left-6 sm:-left-8 lg:-left-2 z-10 h-16 lg:h-20 animate-float-left"
              />
              <img
                src="/membership-top-right.png"
                alt="membership-top-right"
                className="absolute -top-10 sm:-top-5 -right-10 sm:-right-12 lg:-right-8 z-10 h-12 lg:h-16 animate-float-right"
              />
            </h1>
